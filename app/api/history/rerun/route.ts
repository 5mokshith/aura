...
import***REMOVED***{***REMOVED***getWorkflow,***REMOVED***getGoogleOAuthTokens***REMOVED***}***REMOVED***from***REMOVED***"@/lib/supabase/queries";
...
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***Get***REMOVED***original***REMOVED***workflow
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***originalWorkflow***REMOVED***=***REMOVED***await***REMOVED***getWorkflow(workflowId);

***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***Verify***REMOVED***workflow***REMOVED***belongs***REMOVED***to***REMOVED***user
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(originalWorkflow.user_id***REMOVED***!==***REMOVED***user.id)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***NextResponse.json(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{***REMOVED***error:***REMOVED***"Unauthorized***REMOVED***to***REMOVED***rerun***REMOVED***this***REMOVED***workflow"***REMOVED***},
...
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***Create***REMOVED***new***REMOVED***workflow***REMOVED***with***REMOVED***same***REMOVED***command
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***workflowId:***REMOVED***newWorkflowId,***REMOVED***steps***REMOVED***}***REMOVED***=***REMOVED***await***REMOVED***createAndPlanWorkflow(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***user.id,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***originalWorkflow.command
***REMOVED******REMOVED******REMOVED******REMOVED***);

***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***Record***REMOVED***in***REMOVED***history
***REMOVED******REMOVED******REMOVED******REMOVED***await***REMOVED***recordWorkflowHistory(user.id,***REMOVED***newWorkflowId,***REMOVED***originalWorkflow.command,***REMOVED***"planning");
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***message:***REMOVED***"Workflow***REMOVED***rerun***REMOVED***initiated***REMOVED***successfully",
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***}***REMOVED***catch***REMOVED***(error)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***console.error("Error***REMOVED***rerunning***REMOVED***workflow:",***REMOVED***error);
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***NextResponse.json(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{***REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***error:***REMOVED***"Failed***REMOVED***to***REMOVED***rerun***REMOVED***workflow",
